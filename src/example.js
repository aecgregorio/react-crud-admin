...
{id: 5,name: 'Isa Yoll', number: '0908839202',address:{ street: "Barbican Street"}},
{id: 6, name: 'Jon Snow', number: '078890089',address:{ street: "Hallmark Street"}},
{id: 7,name: 'Tom East', number: '07839030300',address:{ street: "Barbican Street"}},
{id: 8,name: 'Isa Yoll', number: '0908839202',address:{ street: "Barbican Street"}},
{id: 9, name: 'Jon Snow', number: '078890089',address:{ street: "Hallmark Street"}},
{id: 10,name: 'Tom East', number: '07839030300',address:{ street: "Barbican Street"}},
{id: 11,name: 'Tom East', number: '07839030300',address:{ street: "Barbican Street"}},
{id: 12,name: 'Isa Yoll', number: '0908839202',address:{ street: "Barbican Street"}},
{id: 13, name: 'Jon Snow', number: '078890089',address:{ street: "Hallmark Street"}},
{id: 14,name: 'Tom East', number: '07839030300',address:{ street: "Barbican Street"}}
];
...
export default class Example extends Admin
{
  ...
  get_queryset(page_number, list_per_page)
  {
    return data;
  }
